    ...
    <div className="app">
      <header className="app-navbar">
        <div className="brand-wrap">
          ...
          <span className="brand-tagline">Organizá tus materias y planificá tu avance.</span>
        </div>
      ...
      <footer>
        ...
        <a href="https://github.com/ftavares19/OrtTracker" target="_blank" rel="noopener noreferrer">
